...
- [kabre.cenat.ac.cr](https://kabre.cenat.ac.cr/) Maintenance, optimization, and usability improvements for the Kabré landing page and information hub, the national supercomputer of Costa Rica, developed for the Centro Nacional de Alta Tecnología (CeNAT) and the Colaboratorio Nacional de Computación Avanzada (CNCA), with a focus on improved responsiveness, clarity, and overall user experience.
